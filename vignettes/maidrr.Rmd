...
Call `autotune(mfit, data, vars, target, hcut = 0.75, pred_fun = NULL, ` 
`lambdas = as.vector(outer(seq(1, 10, 0.1), 10^(-7:3))), nfolds = 5, strat_vars = NULL, `
`glm_par = alist(), err_fun = mse, ncores = -1)` with arguments:
